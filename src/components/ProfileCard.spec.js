...
describe('ProfileCard', () => {
    describe('Layout', () => {
        ...
        it('display user image when user has one', () => {
            const { container } = render(<ProfileCard user={user} />);
            const image = container.querySelector('img');
        ...
        it('displays displayName input when isEditable property set as true', () => {
        ...
        it('hides the edit button in edit mode and isEditable provided as true', () => {
            const { queryByText } = render(
                <ProfileCard user={user} inEditMode={true} isEditabe={true}/>
            );
            const editButton = queryByText('Edit');
            expect(editButton).not.toBeInTheDocument();
        });
